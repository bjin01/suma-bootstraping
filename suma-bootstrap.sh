#!/bin/bash
echo "SUSE Manager Server Client bootstrap script v4.2"
...
#         wget -qO- https://bjsuma.bo2go.home/pub/bootstrap/bootstrap-<edited_name>.sh | /bin/bash
#         ...or...
#         curl -Sks https://bjsuma.bo2go.home/pub/bootstrap/bootstrap-<edited_name>.sh | /bin/bash
...
systemctl list-units -t service | grep salt-minion
if [[ $? -eq 0 ]]
then
